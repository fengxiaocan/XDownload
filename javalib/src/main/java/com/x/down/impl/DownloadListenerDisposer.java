...
public class DownloadListenerDisposer
        implements com.x.down.listener.OnDownloadConnectListener, com.x.down.listener.OnDownloadListener, com.x.down.listener.OnProgressListener, com.x.down.listener.OnSpeedListener {
    private final com.x.down.dispatch.Schedulers schedulers;
    private final com.x.down.listener.OnDownloadListener onDownloadListener;
    private final com.x.down.listener.OnProgressListener onProgressListener;
    private final com.x.down.listener.OnSpeedListener onSpeedListener;
    private final com.x.down.listener.OnDownloadConnectListener onConnectListener;
